...
[![My Skills](https://skillicons.dev/icons?i=php,html,css,vue,react,flutter,nodejs,docker,git,github,windows,linux,graphql,aws,mysql,lua,laravel,discordjs,svg,gmail,htmx,ps,ai,pr,yarn,py,pycharm,cloudflare&perline=8)](https://skillicons.dev)
